  ...
  return (
    <div className="container lg:pr-[200px] mx-auto lg:mx-0">
      ...
      <div className="h-screen">
        ...
        <main className="lg:w-[900px] mx-auto flex items-center justify-center py-20 pt-8 lg:py-0 lg:pt-0 lg:h-full px-10 lg:px-0">
          <div>
            ...
            <div className="flex space-x-4 items-center">
              <a href="https://play.google.com/store/apps/details?id=com.flightly">
                <Image
        ...
        <aside className="lg:absolute lg:-right-40 xl:right-0 -top-0 bottom-0 lg:h-full from-[#ED2DC1] to-[#D93DDD] bg-gradient-135 w-full lg:w-[300px] xl:w-[500px] -skew-y-[30deg]  lg:skew-y-0">
          <div className="relative ml-32 lg:ml-0 top-12 lg:top-0 h-full">
            <div className="skew-y-[30deg] lg:skew-y-0  h-full">
              <div className="hidden lg:block custom-shape-divider-top-1664480058 h-full overflow-y-hidden relative">
                <svg
                  data-name="Layer 1"
              ...
              <div className="relative mt-20 lg:mt-0 lg:absolute -top-20 lg:top-0 flex items-center justify-center h-full lg:right-32 lg:w-[720px]">
                <div className="-ml-52 relative -top-20 pl-30 -mb-40 lg:ml-0 lg:static lg:mb-0">
                  <Image
